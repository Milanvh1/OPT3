...
public class Keuken {
    ...
    public static ArrayList<Maaltijd> BesteldeMaaltijdenLijst() {
        ...
        maaltijdlijst.add(new Maaltijd("Twee ham kaas tosti's" , "", ""));
        maaltijdlijst.add(new Maaltijd("Aardappels met bloemkool, kipfilet en een romige saus", "",""));
    ...
    public static void printTotaalOverzichtMaaltijden() {
        ...
        for (Maaltijd maaltijd : maaltijdlijst) {
            System.out.println("Eten: " + maaltijdlijst.get(0).getEten() + " Drinken: " + maaltijd.getDrinken() +
